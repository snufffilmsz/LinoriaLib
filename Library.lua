...
function Library:CreateWindow(...)
    ...
    function Window:AddPlayersTab()
        local PlayersTab = self:AddTab('Players')
        local PlayerList = PlayersTab:AddLeftGroupbox('Player List')
        ...
        local function CreatePlayerCard(plr)
            ...
            local Avatar = Library:Create('ImageLabel', {
                ...
                Image = Players:GetUserThumbnailAsync(plr.UserId, Enum.ThumbnailType.HeadShot, Enum.ThumbnailSize.Size60x60),
                Parent = Card
            })
